...
\begin{longtable}{|c|p{3.5cm}|p{4cm}|c|c|}
\hline
...
\cline{2-5}
 & \multirow{3}{3.5cm}{Come utente voglio comunicare con il proprietario del parcheggio.}
...
\cline{2-5}
 & \multirow{2}{3.5cm}{Come utente voglio modificare i miei dati personali.}
...
\cline{2-5}
 & \multirow{2}{3.5cm}{Come host voglio visualizzare le prenotazioni ricevute.}
 & API prenotazioni ricevute & Riccardo & 3 \\
\cline{3-5}
 & & UI lista prenotazioni ricevute & Riccardo & 3 \\
\cline{2-5}
 & \multirow{3}{3.5cm}{Come amministratore voglio gestire utenti, posti e prenotazioni.}
