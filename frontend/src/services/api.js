...
export const api = {
  ...
  // Recensioni
  getRecensioni: (postoId) => request(`/recensioni/posto/${postoId}`),
  getMyRecensioni: () => request('/recensioni/mie'),
  createRecensione: (body) => request('/recensioni', { method: 'POST', body: JSON.stringify(body) }),
};